  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Showmessage('Событие успешно добавлено!');
      end
      else
      Showmessage('Тема события: длина слишком большая, сделайте, пожалуйста, её меньше!');
    end
    else
...
begin
  ...
  try
    ...
    for i := 0 to length(MyEvents)-1 do
     ...
     Showmessage('Произошла ошибка при попытке записи информации в файл.');
  end;
  end;
  New_Event.Close;
  Organizer.Show;
